...
class Sort(BaseModel):
    # A card metric (bilanzsumme | revenue | equity_ratio | employees | last_filing_year), or
    # "distance" when a near filter is set. None → default (bilanzsumme desc, or name relevance
    # when a name filter is set).
    field: str | None = None
