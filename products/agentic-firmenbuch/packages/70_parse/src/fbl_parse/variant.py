...
``fbl_core_at.formats`` (siblings never import each other, §3). This module re-exports
...
from fbl_core_at.formats import XmlVariant
from fbl_core_at.formats import detect_xml_variant as detect_variant
